function [spikes, f] = spiculation_quantification(output_experiment_path, obj_filename, sph_map_filename, n_info)
    if nargin < 3
        n_info = [];
    end
    ...
    ce1 = mean(s1.vertices);
        ...
        f = table({pid},{nid},num_spikes,sum(spiculation),sum(lobulation), sum(attached), mean(attachment), ...
                ...
                'VariableNames',{'PID','NID','num_spikes','num_spic','num_lobul','num_attached','attachment', ...
